<div class="list-group">
    ...
    <a href="#" class="list-group-item"><div class="text-center"><?php print $this->session->userdata('full_name'); ?></div><div class="btn btn-danger" style="width: 100%">Logout</div></a>
</div>